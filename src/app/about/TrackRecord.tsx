  ...
  return ( 
    <div className="container">
        <div className="lg:grid lg:grid-cols-4 xl:grid-cols-6 px-4 md:px-6 lg:px-10 xl:px-20 2xl:px-24 gap-6">
            ...
            <div className="lg:col-span-4 xl:col-span-2 py-4 mb-4 lg:mb-0">
             <h2 className="text-5xl font-semibold leading-tight tracking-[-1.5px]">Our Track Record Speaks for Itself</h2>            
            </div>
            ...
            <div className="bg-neutral-01 p-8 sm:p-4 md:p-8 rounded-xl flex-1 min-w-[150px]">
                ...
                <span className="text-neutral-03 font-light">Projects</span>
            </div>
            
            <div className="bg-color-01 text-white p-8 sm:p-4 md:p-8 rounded-xl flex-1 min-w-[150px]">
                <h2 className="text-5xl sm:text-4xl md:text-4xl xl:text-5xl font-semibold pb-4">15,000+</h2>
                <span className="font-light">Volunteers</span>
            </div>
            
            <div className="bg-neutral-01 p-8 sm:p-4 md:p-8 rounded-xl flex-1 min-w-[150px]">
                <h2 className="text-5xl sm:text-4xl md:text-5xl font-semibold pb-4">98%</h2>
                <span className="text-neutral-03 font-light">Project Success</span>
            </div>
            </div>
