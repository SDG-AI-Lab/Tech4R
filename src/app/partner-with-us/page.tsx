...
import styles from "@/app/partner-with-us/partner.module.css"
      ...
      <section className="flex-1">
        <div className="container flex mx-auto p-4 m-6">
          ...
          <div className="container mx-auto flex-1 p-12 m-6">
            <h2 className={styles.title}>Why Partner with Tech4R?</h2>
        ...
        <div className="container mx-auto p-4 m-6 bg-neutral-01 rounded-3xl">
          <h2 className={styles.title}>Host Organisations & Partners</h2>
