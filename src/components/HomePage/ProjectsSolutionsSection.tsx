...
export default function ProjectsSolutionsSection() {
  ...
  return (
    <section className="py-20 bg-white w-full px-4 md:px-8 lg:px-16 xl:px-20">
        ...
        <div ref={leftRef} className="w-full 2xl:w-1/2 flex flex-col justify-center">
          ...
          <div className="flex flex-col gap-4 mb-8 flex-1">
            {categories.map((cat, idx) => (
              <button
                key={cat.id}
                className={`relative text-left rounded-2xl px-6 py-8 border transition-all flex shadow-sm min-h-[120px] ${idx === selectedIndex
